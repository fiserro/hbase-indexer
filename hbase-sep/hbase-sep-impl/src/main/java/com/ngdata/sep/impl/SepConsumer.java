 ...
 * 
 * <p>
 * On a more technical level, SepConsumer is the remote process (the "fake hbase regionserver") to which the
 * regionservers in the hbase master cluster connect to replicate log entries.
 * </p>
 */
public class SepConsumer extends BaseHRegionServer {
	...
	/**
	 * @param subscriptionTimestamp
	 *            timestamp of when the index subscription became active (or more accurately, not
	 *            inactive)
	 * @param listener
	 *            listeners that will process the events
	 * @param threadCnt
	 *            number of worker threads that will handle incoming SEP events
	 * @param hostName
	 *            hostname, this is published in ZooKeeper and will be used by HBase to connect to this
	 ...
	 *            extracts payloads to include in SepEvents
	 */
	public SepConsumer(String subscriptionId, long subscriptionTimestamp, EventListener listener, int threadCnt,

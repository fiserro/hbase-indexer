...
public class SepConsumerIT {
	...
	public void setUp() throws ReplicationException, ZkConnectException, InterruptedException, KeeperException, IOException {
		...
		sepModel.addSubscription(SUBSCRIPTION_NAME, null);
		sepModel.addSubscription(SUBSCRIPTION_WITH_PAYLOADS_NAME, null);
		...
		sepConsumerWithPayloads = new SepConsumer(SUBSCRIPTION_WITH_PAYLOADS_NAME, System.currentTimeMillis(), eventListenerWithPayloads, 3,
				"localhost", zkItf, clusterConf, payloadExtractor);
		sepConsumer.start();

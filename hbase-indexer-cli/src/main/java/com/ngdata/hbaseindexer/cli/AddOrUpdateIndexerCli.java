...
public abstract class AddOrUpdateIndexerCli extends BaseIndexCli {
	 ...
	 * an initial state.
	 */
	protected IndexerDefinitionBuilder buildIndexerDefinition(OptionSet options, IndexerDefinition oldIndexerDef) throws IOException {
	...
	protected byte[] getIndexerConf(OptionSet options, OptionSpec<String> readerOption, OptionSpec<String> configOption,
			Map<String, String> connectionParams) throws IOException {
	 ...
	 *
	 * @param explicit
	 *            List of parameters that were set explicitly
	 * @param connectionParams
	 *            Current connectionParams
	 * @param param
